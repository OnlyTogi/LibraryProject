...
{
    public partial class fkutuphane : Form
    {
        ...
        {
            fkutuphaneduzenleme fkutuphaneduzenleme = new fkutuphaneduzenleme(0);
            fkutuphaneduzenleme.ShowDialog();
        }
        
        private void klist_btn_Click(object sender, EventArgs e)
        {
            string listele = "select * from kutuphane";
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                fkutuphaneduzenleme fkutuphaneduzenleme = new fkutuphaneduzenleme(selectedId);
                fkutuphaneduzenleme.ShowDialog();
            }
        }
        ...
        private void ksil_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                NpgsqlCommand ksilKomutu = new NpgsqlCommand("delete from kutuphane where kutuphaneid=@p1", baglanti);
                ...
                MessageBox.Show("Kütüphane başarıyla silindi");
                baglanti.Close();
            }
            else
            {
