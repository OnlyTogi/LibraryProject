...
namespace kutuphaneProjesi
{
    public partial class teslimal : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                string guncelleme1 = "update kitap set aktiflik=true where kitapid=@p1";
                ...
                string yeniKayit = "update emanet set emanetdurum=false where kutuphaneid=@p1 and uyeid=@p2 and kitapid=@p3";
                ...
                MessageBox.Show("Teslim Alma İşlemi Başarılı");
